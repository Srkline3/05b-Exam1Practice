...
def run_test_problem3a():
    ...
    # -------------------------------------------------------------------------
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (17, 38), 8 lines'
    window4 = rg.RoseWindow(450, 300, title)

    # Test 5 (it is on window 4):
    point = rg.Point(17, 38)
    expected = 62
...
def problem3b(m, point1):
    ...
    sum = 0
    for k in range(m):
        sum = sum + problem3a(window, point1, counterLine)
        point1.y = point1.y + counterPoint
        counterLine = counterLine +2
        counterPoint = counterPoint + 60
